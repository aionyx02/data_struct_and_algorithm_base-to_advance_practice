...
| `docs/adr/0006-plan-curriculum-expansion-to-algorithms-and-mathematics.md` | `adr` | `accepted` | `on_demand` | Plan curriculum expansion to algorithms and mathematics |
