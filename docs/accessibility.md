...
- The Web phase is deferred, but accessibility is a release requirement when it begins.
...
- [ ] Verify verdicts and charts remain understandable without color.
- [ ] Verify Traditional Chinese text and code identifiers can be zoomed without clipping.
