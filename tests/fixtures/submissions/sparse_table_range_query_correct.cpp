...
// Sparse Table for static range minimum and maximum. Level k stores the answer
// for every block of length 2^k; each query combines the two overlapping
// length-2^k blocks that exactly cover the range.
class SparseTable {
public:
