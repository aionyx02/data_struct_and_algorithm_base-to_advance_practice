...
// Known-wrong: point updates change the element but forget to refresh the cached
// block sum. Queries that read a whole interior block via its cached sum then
// return a stale total.
...
public:
    ...
    void set(int index, long long value) {
        // Bug: forgets to update blockSum_ for this element's block.
