// Reference solution for M10-mobius-divisor-block.
// Linear-sieves the Mobius function up to 1e6 (with prefix sums) and answers
// the divisor summatory function via O(sqrt n) divisor blocking.
#include <iostream>
#include <string>
#include <vector>
