...
// Known-wrong: applies path compression during find. Compression rewrites
// parent pointers that the undo log never recorded, so after a rollback the
// structure does not match the pre-checkpoint state.
